...
class TNCreatePublicationWizard(models.TransientModel):
    ...
    def action_create_publications(self):
        ...
        if not config.access_token or not config.store_id:
        ...
        for product in self.product_ids:
            try:
                ...
                # Actualizar stock y precio en variantes
                # El método _sync_stock_and_price_from_odoo actualiza stock y precio
                # desde Odoo hacia la publicación
                ...
                sync_service.export_publication(publication)
                
                created_count += 1
                _logger.info("✅ Publicación creada y exportada exitosamente: %s", publication.title)
